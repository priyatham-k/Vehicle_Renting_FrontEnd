...
function Ownerdashboard() {
  ...
  const labelStyle = { fontSize: "13px", fontWeight: "bold", color: "#555", display: "inline-block", marginBottom: "5px"};
  
  const inputStyle = { fontSize: "14px", padding: "8px", marginBottom: "10px", border: "1px solid #ddd", borderRadius: "4px",boxSizing: "border-box"};
  const validateForm = () => {
    let errors = {};
    ...
    if (!newVehicle.pricePerDay) errors.pricePerDay = "Price per Day is required";
    if (!newVehicle.currentOdoMeter) errors.currentOdoMeter = "Current Odometer is required";
    return errors;
  };
  ...
  return (
    <div id="page-top">
      <div id="wrapper">
        <OwnerSidebar activeSection={activeSection} setActiveSection={setActiveSection} />
        <div id="content-wrapper" className="d-flex flex-column">
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              {activeSection === "rentals" && <OwnerRentalsSection rentals={rentals} />}
          ...
          <form onSubmit={handleFormSubmit}>
            <div className="form-row">
              <div className="form-group col-md-6">
                ...
                />
                {formErrors.make && (
                  <div className="invalid-feedback">{formErrors.make}</div>
                )}
              </div>
              <div className="form-group col-md-6">
            ...
            <div className="form-row">
              <div className="form-group col-md-6">
                ...
                {formErrors.insurance && (
                  <div className="invalid-feedback">{formErrors.insurance}</div>
                )}
              </div>
              <div className="form-group col-md-6">
